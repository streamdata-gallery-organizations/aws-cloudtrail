...
x-complete: 0
info:
  title: AWS CloudTrail API Update Trail
  version: 1.0.0
...
paths:
  ...
  /?Action=RemoveTags:
    get:
      ...
      - in: query
        name: ResourceId
        description: Specifies the ARN of the trail from which tags should be removed
        type: string
      - in: query
        name: TagsList
  ...
  /?Action=StartLogging:
    get:
      ...
      x-api-path-slug: actionstartlogging-get
      parameters:
      - in: query
        name: Name
        description: Specifies the name or the CloudTrail ARN of the trail for which
  ...
  /?Action=StopLogging:
    get:
      ...
      x-api-path-slug: actionstoplogging-get
      parameters:
      - in: query
        name: Name
        description: Specifies the name or the CloudTrail ARN of the trail for which
  ...
  /?Action=UpdateTrail:
    get:
      ...
      x-api-path-slug: actionupdatetrail-get
      parameters:
      - in: query
        name: CloudWatchLogsLogGroupArn
        description: Specifies a log group name using an Amazon Resource Name (ARN),
